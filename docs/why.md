...
`go-ruby-shellwords/shellwords` reimplements Ruby's Shellwords in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-shellwords/shellwords` directly, with no Ruby runtime;
